...
export const level7 = [
  {
    ...
    scale: [0.99, 1, 1] as Vector3Type, 
    startPosition: [7, startY, 0] as Vector3Type, 
    targetPosition: [0, 3.704, -3.226] as Vector3Type, 
  ...
  },
  {
    ...
    scale: [0.99, 1, 1] as Vector3Type, 
    startPosition: [-7, startY, 0] as Vector3Type, 
    targetPosition: [0, 3.704, -0.044] as Vector3Type, 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
     map: '/Group_2.jpg',
  ...
  },
  {
    ...
    targetPosition: [0, 3.612, 2.338] as Vector3Type, 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
     map: '/Group_2.jpg',
