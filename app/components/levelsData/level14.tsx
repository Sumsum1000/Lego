...
export const level14 = [
  {
    ...
    targetPosition: [-6.322, 1.236, -5.609] as Vector3Type,  
  ...
  },
  {
    ...
    targetPosition: [-6.322, 2.2, -6.969] as Vector3Type, 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
    map: '/Group_2.jpg',
  ...
  },
  {
    ...
    scale: [1.05, 1.05, -1.05] as Vector3Type,
    startPosition: [-1, startY, 0] as Vector3Type, 
    targetPosition: [-6.322, 2.2, -4.268] as Vector3Type, 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
    map: '/Group_2.jpg',
  ...
  },
  {
    ...
    scale: [1.05, 1.05, 1.05] as Vector3Type,
    startPosition: [-4, startY, 0]as Vector3Type, 
    targetPosition: [-6.322, 2.604, -5.609]as Vector3Type, 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
    map: '/Group_2.jpg',
  ...
  },
  {
    ...
    scale: [1.05, 1.05, 1.05] as Vector3Type,
    startPosition: [-7, startY, 0] as Vector3Type, 
    targetPosition: [-6.322, 2.2, -7.701] as Vector3Type , 
    centerPosition: centerPosition as Vector3Type, 
    castShadow: true,
    receiveShadow: true,
    map: '/Group_2.jpg',
